...
SurgeLv2Ui::SurgeLv2Ui(SurgeLv2Wrapper *instance, void *parentWindow, const LV2_URID_Map *uridMapper, const LV2UI_Resize *uiResizer)
...
LV2UI_Handle SurgeLv2Ui::instantiate(const LV2UI_Descriptor *descriptor, const char *plugin_uri, const char *bundle_path, LV2UI_Write_Function write_function, LV2UI_Controller controller, LV2UI_Widget *widget, const LV2_Feature *const *features)
{
    SurgeLv2Wrapper *instance = (SurgeLv2Wrapper *)SurgeLv2::requireFeature(LV2_INSTANCE_ACCESS_URI, features);
    ...
    std::unique_ptr<SurgeLv2Ui> ui(new SurgeLv2Ui(instance, parentWindow, featureUridMap, featureResize));
